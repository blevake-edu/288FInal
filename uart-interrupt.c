...
volatile char start_command = 'g';
volatile char stop_command = 's';
...
void uart_interrupt_init(void){
  ...
  UART1_LCRH_R = (UART1_LCRH_R & ~0xFF) + 0b1100000;
...
void uart_set_handler(callback given_fn, void* ctx) {
    handl = given_fn;
    context = ctx;
}
...
//
//            if (byte_received == start_command || byte_received == stop_command) {
